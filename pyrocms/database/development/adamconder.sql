...
--
-- Host: localhost
-- Generation Time: Feb 24, 2014 at 12:03 AM
...
(1, 'Default Site', 'default', 'localhost', 1, 1393080504, 0);
...
(1, 'adam@adamconder.com', '859dc51c8ef02fcd2f2b5c41166e217c06e5fc10', 'c5b95', 1, '', 1, '', 1393080504, 1393080504, 'adamconder', NULL, NULL);
...
CREATE TABLE `default_blog` (
  ...
  `featured_image` char(15) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `default_blog` (`id`, `created`, `updated`, `created_by`, `ordering_count`, `intro`, `title`, `slug`, `category_id`, `body`, `parsed`, `keywords`, `author_id`, `created_on`, `updated_on`, `comments_enabled`, `status`, `type`, `preview_hash`, `featured_image`, `slogan`) VALUES
(1, '2014-02-23 13:43:00', '2014-02-23 13:43:00', 1, 1, 'iOS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:', 'iOS7', 'iOS7', 0, 'iOS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:', '', '9f1a4d8a755b8f12da1e08abccc19548', 1, 1393159380, 1393159380, 'always', 'live', 'wysiwyg-advanced', '', '61047347546678e', 'everything you need to know'),
(2, '2014-02-23 14:52:00', '2014-02-23 14:52:00', 1, 2, 'i<img alt="" class="pyro-image alignment-none" data-pyroimage="true" src="{{ url:site }}files/large/510bb23a4151046" />OS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:<br />\n<br />\niOS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:<br />\n<br />\niOS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:', 'iPhone 6', 'iphone-6', 0, '<img alt="" class="pyro-image alignment-none" data-pyroimage="true" src="{{ url:site }}files/large/510bb23a4151046" />iOS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:<br />\n<br />\niOS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:<br />\n<br />\niOS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:', '', '4957ff4af0af6f83070c796c13b126d3', 1, 1393163520, 1393163520, '3 months', 'live', 'wysiwyg-advanced', '', 'dummy', 'everything you need to know');
...
('a29d31e7bbed575344cae627a46f75d5', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.107 Safari/537.36', 1393083968, 'a:6:{s:8:"username";s:10:"adamconder";s:5:"email";s:19:"adam@adamconder.com";s:2:"id";s:1:"1";s:7:"user_id";s:1:"1";s:8:"group_id";s:1:"1";s:5:"group";s:5:"admin";}'),
('4781f8f12997c2c0441f84fdc4f0e44c', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.117 Safari/537.36', 1393192724, 'a:6:{s:8:"username";s:10:"adamconder";s:5:"email";s:19:"adam@adamconder.com";s:2:"id";s:1:"1";s:7:"user_id";s:1:"1";s:8:"group_id";s:1:"1";s:5:"group";s:5:"admin";}'),
('2a7ff1c929060e9cd901d508d7a245d0', '192.168.1.199', 'Mozilla/5.0 (iPhone; CPU iPhone OS 7_0_4 like Mac OS X) AppleWebKit/537.51.1 (KHTML, like Gecko) Version/7.0 Mobile/11B5', 1393170170, ''),
('57e7ad7a13effe32e3b26ce5ac58468b', '192.168.1.8', 'Mozilla/5.0 (iPad; CPU OS 7_0_3 like Mac OS X) AppleWebKit/537.51.1 (KHTML, like Gecko) CriOS/33.0.1750.14 Mobile/11B511', 1393170228, 'a:1:{s:18:"flash:old:referrer";s:17:"blog/2014/02/iOS7";}');
...
(1, 1, 1, '', '', '', 'Test new message ', '<p>Test new message </p>\n', 'blog', '2', 'iPhone 6', 'blog:post', 'blog:posts', 'blog/2014/02/iphone-6', NULL, 1393166454, '::1'),
(2, 1, 1, '', '', '', 'Nice post!\n', '<p>Nice post!</p>\n', 'blog', '1', 'iOS7', 'blog:post', 'blog:posts', 'blog/2014/02/iOS7', NULL, 1393169578, '::1'),
(3, 1, 1, '', '', '', 'second', '<p>second</p>\n', 'blog', '2', 'iPhone 6', 'blog:post', 'blog:posts', 'blog/2014/02/iphone-6', NULL, 1393169637, '::1'),
(4, 1, 1, '', '', '', 'newer post', '<p>newer post</p>\n', 'blog', '2', 'iPhone 6', 'blog:post', 'blog:posts', 'blog/2014/02/iphone-6', NULL, 1393169643, '::1');
...
(1, 'lang:blog:intro_label', 'intro', 'blogs', 'wysiwyg', 0x613a323a7b733a31313a22656469746f725f74797065223b733a383a22616476616e636564223b733a31303a22616c6c6f775f74616773223b733a313a2279223b7d, NULL, 'no'),
...
(18, 'contentheader', 'content_header', 'pages', 'text', 0x613a323a7b733a31303a226d61785f6c656e677468223b733a303a22223b733a31333a2264656661756c745f76616c7565223b733a303a22223b7d, NULL, 'no'),
(19, 'subheading', 'subheading', 'pages', 'text', 0x613a323a7b733a31303a226d61785f6c656e677468223b733a303a22223b733a31333a2264656661756c745f76616c7565223b733a303a22223b7d, NULL, 'no'),
(20, 'Projects', 'projects', 'pages', 'wysiwyg', 0x613a323a7b733a31313a22656469746f725f74797065223b733a383a22616476616e636564223b733a31303a22616c6c6f775f74616773223b733a313a2279223b7d, NULL, 'no'),
(21, 'Featured Image', 'featured_image', 'blogs', 'image', , NULL, 'no'),
(22, 'Slogan', 'slogan', 'blogs', 'wysiwyg', 0x613a323a7b733a31313a22656469746f725f74797065223b733a383a22616476616e636564223b733a31303a22616c6c6f775f74616773223b733a313a2279223b7d, NULL, 'no');
...
(19, 1, 5, 19, 'no', 'no', '', NULL),
(20, 2, 5, 20, 'no', 'no', '', NULL),
(21, 2, 1, 21, 'no', 'no', '', NULL),
(22, 3, 1, 22, 'yes', 'no', '', NULL);
...
(5, 'Page Type Portfolio', 'portfolio', 'pages', 'pages_', NULL, 0x613a323a7b693a303b733a323a226964223b693a313b733a373a2263726561746564223b7d, NULL, 'title', NULL, 'no', NULL);
...
(2, '2014-02-22 15:48:28', NULL, 1, NULL, '<p>To contact us please fill out the form below.</p>\n				{{ contact:form name="text|required" email="text|required|valid_email" subject="dropdown|Support|Sales|Feedback|Other" message="textarea" attachment="file|zip" }}\n					<div><label for="name">Name:</label>{{ name }}</div>\n					<div><label for="email">Email:</label>{{ email }}</div>\n					<div><label for="subject">Subject:</label>{{ subject }}</div>\n					<div><label for="message">Message:</label>{{ message }}</div>\n					<div><label for="attachment">Attach  a zip file:</label>{{ attachment }}</div>\n				{{ /contact:form }}'),
(3, '2014-02-22 15:48:28', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}'),
(4, '2014-02-22 15:48:28', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}\n\n{{ search:results }}\n\n	{{ total }} results for "{{ query }}".\n\n	<hr />\n\n	{{ entries }}\n\n		<article>\n			<h4>{{ singular }}: <a href="{{ url }}">{{ title }}</a></h4>\n			<p>{{ description }}</p>\n		</article>\n\n	{{ /entries }}\n\n        {{ pagination }}\n\n{{ /search:results }}'),
(5, '2014-02-22 15:48:28', NULL, 1, NULL, '<p>We cannot find the page you are looking for, please click <a title="Home" href="{{ pages:url id=''1'' }}">here</a> to go to the homepage.</p>');
...
('510bb23a4151046', 2, 1, 'i', 'iphone.png', '546504a4de4c0d4ed3d0caacdc602be9.png', '{{ url:site }}files/large/546504a4de4c0d4ed3d0caacdc602be9.png', '', '.png', 'image/png', '', 281, 205, 45, '', 0, 1393164181, 0),
('61047347546678e', 2, 1, 'i', 'featured.png', '55f08eebc4b060ab4a80c7cb44353d28.png', '{{ url:site }}files/large/55f08eebc4b060ab4a80c7cb44353d28.png', '', '.png', 'image/png', '', 645, 303, 194, '', 0, 1393159647, 0),
('8190656f9e3b328', 1, 1, 'i', 'newcollegedurham.png', 'f45348cdfceec3230365c8281974868b.png', '{{ url:site }}files/large/f45348cdfceec3230365c8281974868b.png', '', '.png', 'image/png', '', 206, 304, 88, '', 0, 1393155447, 0),
('f74a131f9c46291', 1, 1, 'i', 'spontly.png', '23561acbe29df7e9379ba8dcaeafdb74.png', '{{ url:site }}files/large/23561acbe29df7e9379ba8dcaeafdb74.png', '', '.png', 'image/png', '', 206, 238, 41, '', 0, 1393156436, 0);
...
(1, 0, 'projects', 'Projects', 'local', '', 1393083861, 1393083861, 0),
(2, 0, 'blog', 'Blog', 'local', '', 1393159157, 1393159157, 0);
...
(1, '9f1a4d8a755b8f12da1e08abccc19548', 1),
(2, '9f1a4d8a755b8f12da1e08abccc19548', 2),
(3, '9f1a4d8a755b8f12da1e08abccc19548', 3),
(6, '4957ff4af0af6f83070c796c13b126d3', 4);
...
(2, 'contact', '', 'Contact', 'contact', 0, '1', '2', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1393080508, 0, '', 0, 1, 1),
(3, 'search', '', 'Search', 'search', 0, '1', '3', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1393080508, 0, '', 0, 1, 2),
(4, 'results', '', 'Results', 'search/results', 3, '1', '4', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1393080508, 0, '', 0, 0, 0),
(5, '404', '', 'Page missing', '404', 0, '1', '5', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1393080508, 0, '', 0, 1, 3),
(8, 'home', '', 'Home', 'home', 0, '4', '1', '', '', '', '', 0, 0, '', 0, 0, 'live', 1393082825, 1393156469, '0', 1, 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `default_pages_portfolio`
--

DROP TABLE IF EXISTS `default_pages_portfolio`;
CREATE TABLE `default_pages_portfolio` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `created` datetime NOT NULL,
  `updated` datetime DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  ...
  `projects` longtext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=2 ;

--
-- Dumping data for table `default_pages_portfolio`
--

INSERT INTO `default_pages_portfolio` (`id`, `created`, `updated`, `created_by`, `ordering_count`, `subheading`, `projects`) VALUES
(1, '2014-02-22 17:27:05', '2014-02-23 13:54:29', 1, 1, 'Hi, I''m Adam Conder and I develop for mobile and web', '<div class="project">\n<div class="project-information">\n<div class="project-title">\n<h4>New College Durham</h4>\n\n<p class="project-slogan">an online prospectus</p>\n</div>\n\n<div class="project-description">\n<p>Description</p>\n\n<p>NCD is an online prospectus that allows users to apply for courses directly with the college through the application.</p>\n</div>\n\n<div class="project-responsibility">\n<p>Responsible for</p>\n\n<p>Cross platform mobile development using the Sencha Framework, django for backend and API development.</p>\n</div>\n\n<div class="project-tags"><span>web app</span><span>django</span><span>phonegap/cordova</span><span>responsive</span></div>\n</div>\n\n<div class="project-image"><img alt="" class="pyro-image alignment-none" data-pyroimage="true" src="{{ url:site }}files/large/8190656f9e3b328" /></div>\n\n<div class="clearFix">&nbsp;</div>\n</div>\n\n<div class="project">\n<div class="project-information">\n<div class="project-title">\n<h4>Spontly</h4>\n\n<p class="project-slogan">the collaborative content sharing app</p>\n</div>\n\n<div class="project-description">\n<p>Description</p>\n\n<p>Spontly is an app that focuses on content sharing via social streams within the app. It enables use to seamlessly share live content with users.</p>\n</div>\n\n<div class="project-responsibility">\n<p>Responsible for</p>\n\n<p>iPhone and Android development</p>\n</div>\n\n<div class="project-tags"><span>iOS</span><span>Android</span></div>\n</div>\n\n<div class="project-image"><img alt="" class="pyro-image alignment-none" data-pyroimage="true" src="{{ url:site }}files/large/f74a131f9c46291" /></div>\n\n<div class="clearFix">&nbsp;</div>\n</div>\n');
...
(1, NULL, NULL, NULL, NULL, 1, 'Adam Conder', 'Adam', 'Conder', '', 'en', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(15, 'Home', '', NULL, NULL, 'pages', 'pages:page', 'pages:pages', '7', 'home', 'admin/pages/edit/7', 'admin/pages/delete/7'),
...
(32, 'Home', '', NULL, NULL, 'pages', 'pages:page', 'pages:pages', '8', 'home', 'admin/pages/edit/8', 'admin/pages/delete/8'),
(36, 'iOS7', 'iOS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:', 'beginners, ios, tutorial', '9f1a4d8a755b8f12da1e08abccc19548', 'blog', 'blog:post', 'blog:posts', '1', 'blog/2014/02/iOS7', 'admin/blog/edit/1', 'admin/blog/delete/1'),
(39, 'iPhone 6', 'iOS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:\n\niOS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:\n\niOS 7, code-named Innsbruck, is the next generation of software for iPhone, iPod touch, and iPad, and was introduced by Apple during the WWDC 2013 keynote on June 10. A radical visual departure from previous generations of iOS, it focuses on clarity by removing all but the most essential interface elements and shifting from buttons to tinted text, deference by getting out of the way of content and apps, and depth by building the entire experience around a real, game-style physics and particle engine that moves, blurs, parallaxes, and layers in virtual 3D. New features include:', 'rumour', '4957ff4af0af6f83070c796c13b126d3', 'blog', 'blog:post', 'blog:posts', '2', 'blog/2014/02/iphone-6', 'admin/blog/edit/2', 'admin/blog/delete/2');
...
('contact_email', 'Contact E-mail', 'All e-mails from users, guests and the site will go to this e-mail address.', 'text', 'adam@adamconder.com', '', '', 1, 1, 'email', 979),
...
('default_theme', 'Default Theme', 'Select the theme you want users to see by default.', '', 'default', 'adamconder', 'func:get_themes', 1, 0, '', 0),
...
('server_email', 'Server E-mail', 'All e-mails to users will come from this e-mail address.', 'text', 'admin@localhost', 'adam@adamconder.com', '', 1, 1, 'email', 978),
...
('site_name', 'Site Name', 'The name of the website for page titles and for use around the site.', 'text', 'Un-named Website', 'Adam Conder', '', 1, 1, '', 1000),
...
('site_slogan', 'Site Slogan', 'The slogan of the website for page titles and for use around the site', 'text', '', 'Developer', '', 0, 1, '', 999),
...
(11, 'slider', 'Slider', 'Would you like to display the slider on the homepage?', 'radio', 'yes', 'yes', 'yes=Yes|no=No', 1, 'adamconder'),
(12, 'show_breadcrumbs', 'Do you want to show breadcrumbs?', 'If selected it shows a string of breadcrumbs at the top of the page.', 'radio', 'yes', 'yes', 'yes=Yes|no=No', 1, 'adamconder');
...
(1, 'adam@adamconder.com', '859dc51c8ef02fcd2f2b5c41166e217c06e5fc10', 'c5b95', 1, '', 1, '', 1393080504, 1393166447, 'adamconder', NULL, 'acc8fa3cfb12a39795496843d56521d46699f9f5');
